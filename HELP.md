...
* The original package name 'rocks.process.Studentstuff.Studentstuff-web' is invalid and this project uses 'rocks.process.Studentstuff.Studentstuffweb' instead.
